...
Query | Description
------|------------
[ras_wikidata_wikipedia](http://zbw.eu/beta/sparql-lab/?endpoint=http://zbw.eu/beta/sparql/repec/query&queryRef=https://api.github.com/repos/zbw/repec-ras/contents/sparql/ras_wikidata_wikipedia.rq) | All RePEc authors mapped to Wikidata, with Wikipedia pages
